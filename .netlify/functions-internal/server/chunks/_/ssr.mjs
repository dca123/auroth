  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "/Users/devinda/Projects/auroth/dist";
        const {
          promises: fs
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-e7s6_TiF.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-BMC16ovm.mjs');
    default:
...
const dotaDbUrl = `${env.DOTA_DB_URL}?authToken=${env.DOTA_DB_TOKEN}`;
const db$2 = drizzle({
  connection: {
    url: env.TURSO_URL,
...
const $$splitComponentImporter$1 = () => import('./index-d5Q9Y9xG.mjs');
const Route$1 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component", () => Route$1.ssr)
});
const $$splitComponentImporter = () => import('./chats._chatId-DdwKspMB.mjs');
...
const datasource$1 = new DataSource({
  ...
  driver,
  flags: 64,
  // this is required to make it work in TypeORM
  database: dotaDbUrl
});
